...
from .models import Book, CartItem, Transaction, CustomUser
...
# book search and listing, title, author, and publisher
def books(request):
...
# displays details of the book, retrieves it based on primary key, ID
# ID is generated by django everytime a book is created
...
# manages user login, check if username and password are valid with error handling
...
"""
Below handles the different functionalities for user that have logged in
"""
@login_required
def my_bag(request):
